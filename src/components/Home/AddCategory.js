...
function AddCategory({ setMainDropDOwn, setsecondDropDown, setThirdDropDown, mainDropDOwn, secondDropDown, thirdDropDown }) {
    ...
    return (
        <div className="card ms-auto me-auto w-25 p-5 mt-1 addCategoryWrapper">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <button type="submit" style={{backgroundColor:"#B881F0", width:"100%"}} class="btn btn-primary mt-3">Add category</button>
            </form>
        </div>
    )
}
